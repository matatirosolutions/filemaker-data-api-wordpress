...
| labels     | The labels to use for the column headers. If omitted then the field names (as above) are used instead. `\|` (pipe) separated                                                                                                                                                                                                                                                                                                                                                                                                                                               | false    |
...
| limit      | The maximum number of records to return in the table. This setting defaults to all records when a query is not provided or the FileMaker Data API default limit of 100 records when a query is applied.                                                                                                                                                                                                                                                                                                                                                                    | false    |
| message    | A message to show when there are no results to display. Defaults to 'No records found'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | false    |
